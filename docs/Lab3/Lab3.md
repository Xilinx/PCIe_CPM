...
Before running the lab, download the top_impl.xdc constraints file available in the [reference design file](https://www.xilinx.com/support/documents/ip_documentation/versal_cips/v3_0/pg347-versal-cpm-dma-v3-0-labs.zip). To do so:

1.  Download the [reference design
    file](https://www.xilinx.com/support/documents/ip_documentation/versal_cips/v3_0/pg347-versal-cpm-dma-v3-0-labs.zip) from the Xilinx website.
...
***Note*:** To locate the top_impl.xdc constraints file, first download the [reference design file](https://www.xilinx.com/support/documents/ip_documentation/versal_cips/v3_0/pg347-versal-cpm-dma-v3-0-labs.zip) file and extract its contents.
